...
st.set_page_config(page_title="Airbnb Advisor", page_icon=":hut:", layout="centered", initial_sidebar_state="auto", menu_items=None)

# Streamlit magic commands for Home Page
'''
# Airbnb Advisor

Welcome to **Airbnb Advisor**. This app aims to provide actionable insights for Airbnb hosts to improve their listings. Whether you're new to hosting or a seasoned veteran, explore select cities and find ways to maximize your profitability, ratings, and visibility.
...
- **🤖 AI Chat**: Got specific questions? Our AI assistant is here to answer specific questions about the data.
